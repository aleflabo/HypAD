...
if __name__ == "__main__":
      ...
      TRAINING
      '''
      encoder, decoder, critic_x, critic_z, path = train(train_loader, params, config_path)


      '''
      ANOMALY DETECTOR
      '''
      anomaly_detection.test_tadgan(test_loader, encoder, decoder, critic_x, read_path=read_path, signal = params.signal, path=path, signal_shape=params.signal_shape, params=params) 
